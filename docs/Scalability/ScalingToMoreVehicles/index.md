...
See the [Third Host Example](https://XXX.github.io/multi-vehicle-framework/Scalability/ScalingToMoreVehicles/#third-host-example) in the framework to add another vehicle.
